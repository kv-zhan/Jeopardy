...
public class JeopardyBoard {
    public boolean answered[][] = new boolean[5][5]; //[row][column]
    private Console c;
    private Color fillColor = new Color(255,220,100);
    private Color blankColor = new Color(80, 80, 80); //add colour later
	...
	for(int i = 0; i < 5; i++) {
	    ...
	    //the title will be gameCategory.categoryName[i]
	}
	for(int i = 0; i < 5; i++) {
	    c.setColor(Color.white);
